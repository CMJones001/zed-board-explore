...
# JC Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN AB6 [get_ports {JC[0]}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {JC[1]}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {JC[2]}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {JC[3]}];  # "JC2_P"
set_property PACKAGE_PIN T6  [get_ports {JC[4]}];  # "JC3_N"
set_property PACKAGE_PIN R6  [get_ports {JC[5]}];  # "JC3_P"
set_property PACKAGE_PIN U4  [get_ports {JC[6]}];  # "JC4_N"
set_property PACKAGE_PIN T4  [get_ports {JC[7]}];  # "JC4_P"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN W7 [get_ports {JD[0]}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {JD[1]}];  # "JD1_P"
set_property PACKAGE_PIN V4 [get_ports {JD[2]}];  # "JD2_N"
set_property PACKAGE_PIN V5 [get_ports {JD[3]}];  # "JD2_P"
set_property PACKAGE_PIN W5 [get_ports {JD[4]}];  # "JD3_N"
set_property PACKAGE_PIN W6 [get_ports {JD[5]}];  # "JD3_P"
set_property PACKAGE_PIN U5 [get_ports {JD[6]}];  # "JD4_N"
set_property PACKAGE_PIN U6 [get_ports {JD[7]}];  # "JD4_P"
...
#set_property PACKAGE_PIN U12  [get_ports {OED_VDD}];  # "OLED-VDD"
